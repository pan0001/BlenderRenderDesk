...
3.0 新增独立编写的 HTML/CSS/JavaScript 共用界面、HTTP API、Bark 持久通知队列与 pywebview 窗口。对接依据为 pywebview 与 Bark 的公开官方 API 文档；不使用 Batch Render Creator 的代码或资产。2.0 自有渲染控制逻辑迁移到 renderdesk/ 与 engine/，保留原文件协议。旧 Qt 界面由网页界面替换。
